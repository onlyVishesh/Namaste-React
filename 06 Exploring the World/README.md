...
4. UI Microservice 
5. Explanation with diagram
6. useEffect()
7. fetch(), Promise
8. Inspect element, Swiggy Website
9. React JS syntax, newer approach to handle fetch()
10. CORS Policy
11. CORS Chrome Extension
12. Live Data API
13. Delete MockData.js file
14. Optional Chaining with an example
15. Spinning Loader
16. Shimmer UI
17. Shimmer Component Code
18. CSS Code for the Shimmer Component
19. Conditional Rendering
20. Using Ternary Operator
21. Why do we need state variables? (useState)
22. useState() usage & explanation
23. Super Power of React
24. Reconciliation & Diff Algorithm Explained
25. Toggle the login & logout button
26. Build a Search Functionality
27. OnChange handler
28. Nice explanation of re-rendering
29. DOM Manipulation & Virtual DOM
30. Search functionality enhanced using toLowerCase() method
