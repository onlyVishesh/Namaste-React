...
1. Visual Code Setup
2. Hello World Program by using plain HTML
3. Hello World Program using Vanilla JavaScript
4. CDN links discussion
5. Hello World Program in Separately writing JS code within <script> tags in HTML
6. React.createElement explanation
7. Nested Elements
8. Array of children
9. Need o Rearrangement of CDN files
10. React Library v/s Framework discussion
